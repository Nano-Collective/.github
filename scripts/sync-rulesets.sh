...
# nanotune and nanoterm are deliberately excluded until coverage reaches 80
# (decision Q18). Add them here when their tracking issues close.
DEFAULT_REPOS="nanocoder sentinel prompt-scrubber get-md json-up"
